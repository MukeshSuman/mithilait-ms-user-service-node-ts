...
export class SpeechController extends Controller {
    ...
    // @Security('jwt')
    public async transcribeAudioFile(@Request() req: any): Promise<ApiResponse<any>> {
    ...
    public async transcribeAudioFileA(@Request() req: any): Promise<ApiResponse<any>> {
        const result = await this.speechService.pronunciationAssessmentContinuousWithFile();
        return new ApiResponse(200, true, 'successful', { pass: 'pass' });
    }
